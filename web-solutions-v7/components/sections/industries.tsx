  ...
  return (
    <section id="industries" className="scroll-mt-24 border-y border-line bg-mist">
      <div className="mx-auto max-w-7xl px-6 py-24 md:py-36">
        ...
        <div className="mt-16 grid grid-cols-1 items-start gap-10 lg:grid-cols-[300px_minmax(0,1fr)] lg:gap-16">
          {/* Industry selector */}
          <Reveal>
            <div
              ref={listRef}
          ...
          <Reveal delay={0.1}>
            ...
            <div className="relative min-w-0">
              <div
                className="pointer-events-none absolute -inset-3 rounded-3xl opacity-60 blur-2xl transition-colors duration-700 sm:-inset-6"
                style={{ background: d.soft }}
                aria-hidden
              />
              {/* Preview stage: fixed max, always centered, never overflows */}
              <div className="relative mx-auto w-full max-w-[420px] sm:max-w-[560px] lg:max-w-none">
              <Tilt max={5}>
