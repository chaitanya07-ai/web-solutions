...
import InteractiveDemo from "@/components/demo-site";
...
const PROJECTS: Project[] = [
  {
    ...
    demo: {
      navMenu: "Menu",
      slotLabel: "Tonight's tables",
      slots: ["7:00 PM", "7:30 PM", "9:00 PM", "9:30 PM"],
      items: [
        { name: "Chef's Tasting Menu", price: "₹2,400", desc: "Seven courses, seasonal" },
        { name: "Butter Garlic Prawns", price: "₹680", desc: "Coastal classic" },
        { name: "Dal Saffron", price: "₹420", desc: "Slow-cooked signature" },
        { name: "Mango Mishti", price: "₹320", desc: "Dessert of the house" },
      ],
      about:
        "Chef Arjun Mehta's twelve-table dining room celebrates modern Indian cooking — one seasonal tasting menu, cooked over fire, changed with the markets.",
      address: "14 Marine Lines, Mumbai",
  ...
  },
  {
    ...
    demo: {
      navMenu: "Classes",
      slotLabel: "Today's sessions",
      slots: ["6:00 AM", "7:00 AM", "6:00 PM", "7:30 PM"],
      items: [
        { name: "HIIT 45", price: "$15", desc: "High-intensity, all levels" },
        { name: "Strength Basics", price: "$12", desc: "Barbell fundamentals" },
        { name: "Yoga Flow", price: "$10", desc: "Recovery & mobility" },
        { name: "Open Gym", price: "Free", desc: "Members, anytime" },
      ],
      about:
        "A strength-first club in the heart of Toronto — 42 coached classes a week, real barbells, and zero posing culture.",
  ...
  },
  {
    ...
    demo: {
      navMenu: "Services",
      slotLabel: "This week",
      slots: ["Tue 11:00", "Wed 14:30", "Fri 10:00", "Sat 16:00"],
      items: [
        { name: "Colour & Cut", price: "£85", desc: "With a senior stylist" },
        { name: "Blow-dry", price: "£35", desc: "In and out in 40 min" },
        { name: "Bridal Trial", price: "£120", desc: "Hair & makeup preview" },
        { name: "Gloss Treatment", price: "£45", desc: "Shine that lasts weeks" },
      ],
      about:
        "A calm little studio off Marylebone High Street — colour specialists, honest advice, and tea that isn't an afterthought.",
      address: "8 Moxon St, London",
  ...
  },
  {
    ...
    demo: {
      navMenu: "Care",
      slotLabel: "Next available",
      slots: ["Mon 9:20", "Tue 15:40", "Wed 11:00", "Thu 8:30"],
      items: [
        { name: "General Check-up", price: "$60", desc: "30-minute consult" },
        { name: "Pediatric Visit", price: "$75", desc: "Ages 0 – 16" },
        { name: "Lab Panel", price: "$40", desc: "Results in your portal" },
        { name: "Telehealth", price: "$35", desc: "From your sofa" },
      ],
      about:
        "Family medicine without the phone tag — same-week appointments, clear communication, and doctors who remember your name.",
      address: "410 Congress Ave, Austin",
      hours: "Mon – Fri · Walk-ins welcome",
    },
  },
  {
    brand: "The Meridian",
    ...
    demo: {
      navMenu: "Suites",
      slotLabel: "Check-in",
      slots: ["Fri 12 Jun", "Sat 13 Jun", "Sun 14 Jun", "Mon 15 Jun"],
      items: [
        { name: "River Suite", price: "฿4,900", desc: "Corner view, floor 9" },
        { name: "Deluxe King", price: "฿3,200", desc: "Garden side" },
        { name: "Garden Villa", price: "฿6,500", desc: "Private plunge pool" },
        { name: "Breakfast Add-on", price: "฿450", desc: "Riverside terrace" },
      ],
      about:
        "Thirty-four suites on the Chao Phraya — quiet luxury, sunset seatings on the rooftop, and our best rate always direct.",
      address: "48 Charoen Krung Rd, Bangkok",
      hours: "Reception 24/7 · Free transfer",
    },
  },
  {
    brand: "Maison Store",
    ...
    demo: {
      navMenu: "Shop",
      slotLabel: "Pickup time",
      slots: ["Today 2 PM", "Today 5 PM", "Tmrw 11 AM", "Tmrw 4 PM"],
      items: [
        { name: "Ceramic Carafe", price: "$48", desc: "Hand-thrown, matte" },
        { name: "Linen Throw", price: "$89", desc: "Stonewashed, oat" },
        { name: "Oak Serving Tray", price: "$36", desc: "Solid, oiled" },
        { name: "Candle No. 4", price: "$28", desc: "Cedar & fig" },
      ],
      about:
        "A tight edit of objects worth keeping — small makers, honest materials, and new drops every Thursday.",
      address: "31 Crown St, Surry Hills, Sydney",
      hours: "Click & collect · Ready in 2 hrs",
    },
  },
];
          ...
          >
            <Tilt>
              ...
              <div className="md:hidden">
                <PhoneFrame className="mx-auto w-[clamp(230px,72vw,290px)]">
    ...
    <section id="work" className="scroll-mt-24 bg-paper">
      <div className="mx-auto max-w-7xl px-6 py-24 md:py-36">
        <SectionHeading
          ...
          lede="Every project started with a business problem, not a design brief. Tap any preview to open a working demo — book a table that isn't real."
        />
        ...
        {open && (
          ...
          >
            <motion.div
              ...
              className="no-scrollbar max-h-[92vh] w-full max-w-3xl overflow-y-auto"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="mb-3 flex items-center justify-between">
                <p className="text-xs font-semibold uppercase tracking-widest2 text-paper/70">
                  {open.brand} · live interactive demo
                </p>
                <button
                  onClick={() => setOpen(null)}
              ...
              <div className="hidden sm:block">
                <BrowserFrame url={open.domain} dark={open.dark}>
                  <InteractiveDemo p={open} />
                </BrowserFrame>
              </div>
              <div className="mx-auto sm:hidden">
                <PhoneFrame className="max-w-[300px]">
                  <InteractiveDemo p={open} mobile />
                </PhoneFrame>
              </div>
              <p className="mt-3 text-center text-[11px] font-bold uppercase tracking-widest2 text-gold">
                Fully interactive — click around, book something
              </p>
