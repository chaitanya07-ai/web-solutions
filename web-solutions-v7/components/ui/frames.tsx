...
export function BrowserFrame({
  ...
  return (
    <div
      className={cn(
        "min-w-0 overflow-hidden rounded-2xl border shadow-lift",
...
export function PhoneFrame({
  ...
  return (
    <div
      className={cn(
        "relative mx-auto w-full min-w-0 max-w-[min(380px,100%)] overflow-hidden rounded-[2.6rem] border border-line bg-white shadow-lift",
        className
      )}
    >
