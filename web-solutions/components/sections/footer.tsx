        ...
        <div className="grid gap-14 md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          ...
          <div>
            <a href="#top" className="flex items-center gap-2.5">
              <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-gold font-display text-sm italic text-ink">
                W
              </span>
            ...
            <p className="mt-5 max-w-xs text-sm leading-relaxed text-paper/50">
              A premium web design studio building websites that build
              businesses — for restaurants, cafes and ambitious brands in six
            ...
            <div className="mt-7 flex gap-3">
              {[
                ...
                { icon: Video, href: SITE.meet, label: "Book a Google Meet" },
              ].map((s) => (
                <a
                  key={s.label}
                  href={s.href}
