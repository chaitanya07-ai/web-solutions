    ...
    <section className="border-y border-line bg-mist">
      <div className="mx-auto max-w-7xl px-6 py-24 md:py-36" ref={ref}>
        <SectionHeading
          ...
          lede="Orders, revenue, visitors and bookings — updating in real time below. Every website we build can ship with a control room like this."
        />

        <Reveal delay={0.1} className="mt-16">
          <div className="relative mx-auto max-w-5xl">
            <div className="absolute -inset-8 rounded-[2.5rem] bg-gold/[0.07] blur-3xl" aria-hidden />
