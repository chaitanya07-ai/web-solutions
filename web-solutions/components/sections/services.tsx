...
const SERVICES: Service[] = [
  {
    ...
    desc: "A bespoke, conversion-focused website designed around your brand and built to feel effortless. Restaurants and cafes are our home turf — but the same craft goes into every industry we touch.",
    tags: ["Restaurant websites", "Cafe websites", "Custom design", "Mobile responsive"],
  },
  {
    n: "02",
    title: "Smart e-menu & QR menu",
    desc: "Guests scan a code and land on a beautiful, always-up-to-date digital menu. Change prices in seconds, highlight specials, and never print a menu again.",
