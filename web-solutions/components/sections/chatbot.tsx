        ...
        <div className="grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
          ...
          <div>
            <SectionHeading
              ...
              lede="This is a live demo — go on, tap a question. On your website, this assistant is trained on your menu, your hours and your policies, and it answers every customer in seconds."
            />
            <Reveal delay={0.15}>
