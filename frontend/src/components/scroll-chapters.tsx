...
function ProjectScene({ project, index, active }: { project: Project; index: number; active: boolean }) {
  ...
  const x = useSpring(0, { stiffness: 90, damping: 30 });
  const y = useSpring(0, { stiffness: 90, damping: 30 });
