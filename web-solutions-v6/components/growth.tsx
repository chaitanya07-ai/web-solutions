...
import { Bot, Gift, MessageCircle, Phone, TrendingDown } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-md grid-cols-4 gap-1.5">
        <a
          href={SITE.phoneHref}
          className="flex h-11 items-center justify-center gap-1 rounded-full border border-line bg-white text-[11px] font-bold text-ink"
        >
          <Phone className="h-3.5 w-3.5 shrink-0 text-gold-deep" /> Call
        </a>
        <a
          href={SITE.whatsapp}
          target="_blank"
          ...
          className="flex h-11 items-center justify-center gap-1 rounded-full border border-line bg-white text-[11px] font-bold text-ink"
        >
          <MessageCircle className="h-3.5 w-3.5 shrink-0 text-gold-deep" /> Chat
        </a>
        <a
          href={SITE.meet}
          data-book
          ...
          className="flex h-11 items-center justify-center gap-1 rounded-full border border-line bg-white text-[11px] font-bold text-ink"
        >
          <Bot className="h-3.5 w-3.5 shrink-0 text-gold-deep" /> AI call
        </a>
        <a
          href="#contact"
          data-sample
          className="flex h-11 items-center justify-center gap-1 rounded-full bg-gold text-[11px] font-bold text-ink shadow-soft"
        >
          <Gift className="h-3.5 w-3.5 shrink-0" /> Sample
        </a>
      </div>
    </motion.div>
  );
