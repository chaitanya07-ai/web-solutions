...
const RULES: { match: RegExp; reply: string; contact?: boolean; book?: boolean; sample?: boolean }[] = [
  ...
  },
  {
    ...
    reply:
      "We build complete growth systems: premium websites, AI chatbots & voice agents, WhatsApp and Instagram automation, AI appointment booking, payments, dashboards with CRM, and SEO with ongoing care — for restaurants, salons, gyms, clinics, hotels, stores and more.",
  },
  {
