...
export default function CTA() {
  ...
  const spotlight = useMotionTemplate`radial-gradient(560px at ${mx}px ${my}px, rgba(212,175,55,0.13), transparent 70%)`;
  ...
  return (
    ...
    >
      <motion.div className="absolute inset-0" style={{ background: spotlight }} aria-hidden />
